...
public class InstructorManager extends UserManager{
    ...
    //bunun sonucunda da InstructorManager sınıfında 2 adet commonOperationOne metotu olmuş oldu biri User tipinde bir parametre beklerken diğeri Instructor tipinde bir parametre bekliyor olacaktır
    ...
    public void commonOperationOne(Instructor instructor) {
        System.out.println("Ortak operasyon 1 instructor dan çalştı");
    }
    ...
    public void commonOperationTwo(Instructor instructor) {
        System.out.println("Ortak operasyon 2 instructor dan çalştı");
    }
    ...
    public void commonOperationThree(Instructor instructor) {
        System.out.println("Ortak operasyon 3 instructor dan çalştı");
    }

    public void specificOperation(Instructor instructor){
        System.out.println("instructor özel operasyon çalıştı");
    }
